...
public class UpdateMealActivity extends AppCompatActivity {
    ...
    Button bUpdate;
    String selectedId, mealDayUpdate, mealNameUpdate, mealDifficultyUpdate, mealTimeUpdate, mealIngredientsUpdate, mealIngredientsIsCheckedUpdate, mealDirectionsUpdate;
    Integer id;
